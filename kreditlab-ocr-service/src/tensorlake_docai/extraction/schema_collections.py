...
"""Sample schemas for testing structured extraction.

These are intentionally generic — add your own pydantic models or JSON
schemas in your own code rather than checking customer-specific schemas
into the repo.
"""
...
class Receipt(BaseModel):
    ...
    receipt_date: Optional[date] = Field(None, description="Date of the receipt")
